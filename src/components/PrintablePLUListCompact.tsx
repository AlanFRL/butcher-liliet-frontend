...
interface PrintablePLUListCompactProps {
  products: Product[];
...
/**
 * Lista PLU optimizada SIN columna de descuentos
 * Máximo aprovechamiento de espacio
 */
export const PrintablePLUListCompact: React.FC<PrintablePLUListCompactProps> = ({ products, categories, printDate }) => {
