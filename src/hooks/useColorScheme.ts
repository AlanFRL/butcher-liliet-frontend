...
/**
 * Hook que carga y aplica el esquema de colores guardado en localStorage
 * al montar la aplicación. Esto asegura que el tema persista entre sesiones.
 */
export const useColorScheme = () => {
  useEffect(() => {
    // Cargar el esquema de colores guardado (o usar 'default')
